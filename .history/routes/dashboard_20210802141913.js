...
router.post("/dashboard/images", logoUpload.single("uploadImage"),  async (req, res) => {
    ...
    fs.unlink("public/images/partner/" + image, (err) => {
      err ? console.log(err) : res.redirect("/dashboard/photos");
    });
