...
const article = new News({
    title: "Euer Voting wird ausgwertet!",
    ...
    theme: "light",
    text: "Durch eure Stimmen wird entschieden ob wir die App-Entwicklung fortführen oder nicht. Wenn wir davon überzeugt sind, dass ihr die App annhemen werdet, sind wir noch motivierter als bisher alles daran zu setzen, euch diese App, schnellstmöglich, zu präsenentieren. Wir werden zudem veruschen auf jede eurer Anregungen einzugehen und diese, insofern sie mit unseren Ideen vereinbar sind, in die App umsetzen. Wenn ihr noch Fragen zu der App habt, dann lasst es uns wissen und schreibt uns eine kurze Nachricht mit eurer Frage, wir werden umgehend auf euch zurückkommen und hoffen alle offenen Fragen zu beantworten. ANKERPUNKT ZU KONTAKTFORMULAR!"
});
