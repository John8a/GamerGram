...
mongoose.connect('mongodb+srv://johnhardenberg:Lehecejo6!@cluster00-uik3y.mongodb.net/test?retryWrites=true&w=majority', {
// mongoose.connect('mongodb+srv://jurek@:IAte100Cheesecakes@nanovdemo-r8cse.mongodb.net/test?retryWrites=true&w=majority', {
...
const connectWithRetry = () => {
  ...
  mongoose.connect("mongodb+srv://dbAdmin:IAte100Cheesecakes@cluster00-uik3y.mongodb.net/test?retryWrites=true&w=majority", options).then(()=>{
